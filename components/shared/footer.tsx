...
export function Footer({ title, address, phone, mapEmbedUrl, themeColor = "bg-gray-900" }: FooterProps) {
    return (
        <footer className="bg-gray-50 dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800 pt-16 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 text-gray-600 dark:text-gray-400">
                            <div className="flex items-start gap-3">
                                <MapPin className="w-5 h-5 mt-1 shrink-0 text-gray-400 dark:text-gray-500" />
                                <p className="max-w-xs leading-relaxed">{address}</p>
                            </div>
                            <div className="flex items-center gap-3">
                                <Phone className="w-5 h-5 shrink-0 text-gray-400 dark:text-gray-500" />
                                <p>{phone}</p>
                            </div>
                        </div>
                    ...
                    <div className="hidden lg:block space-y-6">
                        ...
                        <ul className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
                            <li><Link href="#home" className="hover:text-gray-900 dark:hover:text-white">Home</Link></li>
                            <li><Link href="#about" className="hover:text-gray-900 dark:hover:text-white">About Us</Link></li>
                            <li><Link href="#services" className="hover:text-gray-900 dark:hover:text-white">Services</Link></li>
                            <li><Link href="#contact" className="hover:text-gray-900 dark:hover:text-white">Contact</Link></li>
                        </ul>
                    </div>

                    {/* Map */}
                    <div className="space-y-6 h-64 rounded-xl overflow-hidden bg-gray-200 border border-gray-100 dark:border-gray-800 shadow-sm">
                        <iframe
                            src={mapEmbedUrl}
                            width="100%"
                            height="100%"
